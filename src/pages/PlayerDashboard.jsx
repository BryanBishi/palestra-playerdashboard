...
const OBtn = ({ children, onClick, style = {}, variant = "primary" }) => (
  <button onClick={onClick}
    style={{
      ...
      padding: "9px 20px", backgroundColor: variant === "danger" ? "#cc3333" : "#2f9be0",
      color: "#fff", border: "none", borderRadius: "8px",
      fontSize: "13px", fontWeight: "700", cursor: "pointer",
      boxShadow: "0 2px 8px rgba(47,155,224,0.28)", ...style,
    }}
    onMouseEnter={e => (e.currentTarget.style.backgroundColor = variant === "danger" ? "#b22a2a" : "#2380c2")}
    onMouseLeave={e => (e.currentTarget.style.backgroundColor = variant === "danger" ? "#cc3333" : "#2f9be0")}
  >
    {children}
  </button>
);
...
// ─── STAT CHIP ───────────────────────────────────────────────────────────
const StatChip = ({ icon: Icon, label, value, color = "#2f9be0" }) => (
    ...
    <div>
      ...
      <div style={{ display: "flex", gap: "8px", marginBottom: "18px", flexWrap: "wrap" }}>
        {[
          ...
          { icon: Heart,    label: "Fatigue",    value: latest.fatigue    ?? "–", color: "#2f9be0" },
        ...
        {["bar", "line", "radar"].map(t => (
          <button
            ...
            style={{
              ...
              border: `1.5px solid ${chartType === t ? "#2f9be0" : "#e8e8e8"}`,
              background: chartType === t ? "#fff5ed" : "#fff",
              color: chartType === t ? "#2f9be0" : "#888",
        ...
        {chartType === "radar" && (
          <ResponsiveContainer width="100%" height="100%">
            <RadarChart data={radarData}>
              ...
              <Radar name="Today" dataKey="Today" stroke="#2f9be0" fill="#2f9be0" fillOpacity={0.35} />
...
const NFTCScore = () => {
  ...
  const scores = [
    { label: "Neuromuscular", value: 78, color: "#2f9be0", desc: "Reaction time & coordination within optimal range" },
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "20px", marginBottom: "24px", padding: "18px", background: "#fff8f2", borderRadius: "10px", border: "1px solid #e8e8e8" }}>
        <div style={{ position: "relative", flexShrink: 0 }}>
          <svg width="88" height="88" viewBox="0 0 96 96">
            ...
            <circle cx="48" cy="48" r="40" fill="none" stroke="#2f9be0" strokeWidth="8"
          ...
          <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
            <div style={{ fontSize: "20px", fontWeight: "700", color: "#2f9be0" }}>{overall}</div>
        ...
        <div>
          ...
          <div style={{ marginTop: "8px", padding: "4px 12px", background: "#fff3e0", borderRadius: "6px", display: "inline-block" }}>
            <span style={{ fontSize: "12px", fontWeight: "700", color: "#2f9be0" }}>
...
const ConsultModal = ({ onClose }) => {
  ...
  const options = [
    { id: "trainer", label: "Trainer", icon: Dumbbell, color: "#2f9be0", name: "Rahul Singh", time: "Tomorrow 9:00 AM" },
    { id: "physio", label: "Physiotherapist", icon: Stethoscope, color: "#2f9be0", name: "Dr. Arun Kumar", time: "Today 4:00 PM" },
    { id: "nutritionist", label: "Nutritionist", icon: Apple, color: "#2f9be0", name: "Anjali Nair", time: "Tomorrow 11:00 AM" },
  ];
      ...
      <div style={{ background: "#fff", borderRadius: "12px 12px 0 0", padding: "24px", width: "100%", maxWidth: "480px", maxHeight: "90vh", overflowY: "auto", boxShadow: "0 -4px 20px rgba(0,0,0,0.1)" }}>
        ...
        {step === 1 ? (
              ...
              {options.map(opt => {
                ...
                return (
                  <button key={opt.id} onClick={() => handleChoose(opt)}
                    ...
                    onMouseEnter={e => { e.currentTarget.style.borderColor = "#2f9be0"; e.currentTarget.style.background = "#fff8f2"; }}
                    onMouseLeave={e => { e.currentTarget.style.borderColor = "#e8e8e8"; e.currentTarget.style.background = "#fff"; }}
                  >
                    <div style={{ width: "40px", height: "40px", borderRadius: "8px", background: "#e8f3fb", display: "flex", alignItems: "center", justifyContent: "center" }}>
                    ...
                    <div style={{ fontSize: "11px", color: "#2f9be0", fontWeight: "600" }}>{opt.time}</div>
                  </button>
                );
              })}
            </div>
          ...
          <div style={{ textAlign: "center", padding: "16px 0" }}>
            <div style={{ width: "64px", height: "64px", borderRadius: "50%", background: "#e8f3fb", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 16px" }}>
              <CheckCircle2 size={34} style={{ color: "#2f9be0" }} />
            </div>
            ...
            <div style={{ fontSize: "13px", color: "#666", lineHeight: "1.6", marginBottom: "4px" }}>
              Your consultation with <strong style={{ color: "#2f9be0" }}>{chosen.name}</strong>
            </div>
            <div style={{ fontSize: "13px", color: "#888", marginBottom: "20px" }}>
              ({chosen.label}) is confirmed for <strong>{chosen.time}</strong>.
            </div>
            <button onClick={onClose} style={{ width: "100%", padding: "12px", borderRadius: "8px", backgroundColor: "#2f9be0", border: "none", color: "#fff", fontWeight: "700", fontSize: "13px", cursor: "pointer" }}>
              Back to Dashboard
            </button>
          </div>
        )}
    ...
    return (
      <div style={{ padding: "28px", maxWidth: "700px", margin: "0 auto" }}>
        ...
        <div style={card({ padding: "24px", marginBottom: "20px", borderLeft: "5px solid #2f9be0" })}>
          ...
          {inj.description && (
            <div style={{ marginTop: "16px", padding: "14px", background: "#f9f9f9", borderRadius: "8px", borderLeft: "4px solid #2f9be0" }}>{inj.description}</div>
          )}
        </div>
        ...
        <div style={card({ overflow: "hidden" })}>
          ...
          {teamMembers.map((m, i) => (
            <div key={i} style={{ display: "flex", alignItems: "center", padding: "15px 22px", borderBottom: i < teamMembers.length - 1 ? "1px solid #f5f5f5" : "none", gap: "16px" }}>
              <div style={{ width: "42px", height: "42px", borderRadius: "50%", backgroundColor: "#e8f3fb", border: "2px solid #ffd8b0", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: "700", color: "#2f9be0" }}>
                {m.number}
              </div>
              <div style={{ flex: 1 }}>
  ...
  return (
    <div style={{ padding: "28px", maxWidth: "900px", margin: "0 auto" }}>
      ...
      <div style={card({ padding: "20px 24px", marginBottom: "20px", position: "relative" })}>
        <div style={{ position: "absolute", top: 0, right: 0, width: "120px", height: "120px", background: "radial-gradient(circle, rgba(47,155,224,0.06) 0%, transparent 70%)" }} />
        <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
          <div style={{ width: "58px", height: "58px", borderRadius: "50%", backgroundColor: "#e8f3fb", border: "1.5px solid #ffd8b0", display: "flex", alignItems: "center", justifyContent: "center" }}>
            <User size={26} style={{ color: "#2f9be0" }} />
          </div>
          <div style={{ flex: 1 }}>
